    ...
    public class MessagesController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> Post([FromBody]Activity activity)
        {
            if (activity.Type == ActivityTypes.Message)
            {
                ...
                {
                    message = "Intentaste enviar una imagen? Soy algo visual :). " +
                        "Intenta enviarme una imagen o una URL de una imagen";

                    Trace.TraceError(e.ToString());
                }
                catch (Exception e)
                {
                    message = "Oops! Algo salio mal. Por favor vuelve a intentarlo";
            ...
            switch (activity.Type)
            {
                ...
                case ActivityTypes.ConversationUpdate:
                    ...
                    if (activity.MembersAdded.Any(m => m.Id == activity.Recipient.Id))
                    {
                        ...
                        response.Text = "Hola! Soy un Bot que procesa imagenes. Puedo entender que es lo que contiene la mayoria de las imagenes" +
                                        " y tratar de describirlo como lo haria cualquier humano. Intenta enviarme una imagen o una URL :).";
